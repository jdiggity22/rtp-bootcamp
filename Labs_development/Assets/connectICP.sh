...
ICPHOST=<replace with default host url, example: https://169.10.44.99 without port number>
ICPUSER=<replace with default user name, example: admin>
ICPPASSWORD=<replace with default password, example "P@SSword" put in double quotes>
ICPCLUSTER=<replace with default cluster name, exapmle: mycluster.icp >
ICPNAMESPACE=<replace with default namespace, example: kube-system>
